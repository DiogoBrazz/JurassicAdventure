...
public class GallimimusEntity extends AbstractDinoEntity {

    public GallimimusEntity(EntityType<? extends AbstractDinoEntity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    // --- 1. ATRIBUTOS DO DINOSSAURO ---
    // --- ESCALA DO DINO BEBE ---
    private static final float DINO_INITIAL_SCALE = 0.15F;
    // --- TEMPO DE CRESCIMENTO ---
    private static final int GROWTH_TIME = 12000;  // 10 minutos para crescer
    // --- VIDA ---
    private static final double BABY_MAX_HEALTH = 4.0D;
    private static final double ADULT_MAX_HEALTH = 20.0D;
    // --- ATAQUE ---
    private static final double BABY_ATTACK_DAMAGE = 0.5D;
    private static final double ADULT_ATTACK_DAMAGE = 1.0D;
    private static final double DINO_ATTACK_KNOCKBACK = 0.1D;
    // --- ARMADURA E RESISTENCIA ---
    private static final double DINO_ARMOR = 0.0D;
    private static final double DINO_KNOCKBACK_RESISTANCE = 0.0D;
    // --- MOVIMENTAÇÃO ---
    private static final double DINO_MOVEMENT_SPEED = 0.35D;
    private static final double DINO_SWIM_SPEED = 1.0D;
    private static final double DINO_FOLLOW_RANGE = 16.0D;
    // --- HITBOX ---
    ...
    public static final float ADULT_HEIGHT = 2.2F;
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new PanicGoal(this, 1.8D)); // Corre muito rápido quando em pânico
        this.goalSelector.addGoal(1, new FloatGoal(this));
        this.goalSelector.addGoal(2, new BreedGoal(this, 1.0D));
        this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, Monster.class, 12.0F, 1.5D, 1.8D));
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.2D, Ingredient.of(Items.WHEAT_SEEDS), false));
