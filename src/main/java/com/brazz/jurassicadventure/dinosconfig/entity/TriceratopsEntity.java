...
public class TriceratopsEntity extends AbstractDinoEntity {

    public TriceratopsEntity(EntityType<? extends AbstractDinoEntity> pEntityType, Level pLevel) {
    ...
    private static final double ADULT_ATTACK_DAMAGE = 12.0D;
    private static final double DINO_ATTACK_KNOCKBACK = 1.5D;
    // --- ARMADURA E RESISTENCIA ---
    private static final double DINO_ARMOR = 8.0D;
    private static final double DINO_KNOCKBACK_RESISTANCE = 0.8D;
    // --- MOVIMENTAÇÃO ---
    private static final double DINO_MOVEMENT_SPEED = 0.22D;
    private static final double DINO_SWIM_SPEED = 1.0D;
    private static final double DINO_FOLLOW_RANGE = 24.0D;
    // --- HITBOX ---
    private static final float BABY_WIDTH = 0.4F;
    private static final float BABY_HEIGHT = 0.45F;
    public static final float ADULT_WIDTH = 3.0F;
    public static final float ADULT_HEIGHT = 3.5F;
